        ...
        <main className="flex min-h-screen flex-col items-center justify-center px-6">
            ...
            {user ? (
                <div className="mt-8 w-full max-w-md rounded-xl border border-slate-800 bg-slate-900 p-6 text-center">
                    ...
                    <Link
                        href="/problems"
                        className="mt-6 inline-flex w-full items-center justify-center rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-emerald-500"
                    >
